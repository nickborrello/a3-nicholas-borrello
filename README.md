...
- **Tech Achievement 1**: I used OAuth authentication via passport.js. This was very difficult to implement, but I was able to get it working with the help of the passport.js documentation and a few tutorials.
